       ...
       {/* <Router>
         ...
         <BrowserRouter>
           ...
           <Routes>
              ...
              <Route  path='/' element={ <News key={"general"} pageSize={this.pageSize}  category={"general"} country={"us"} />   } />
               <Route  path='business' element={ <News key={"business"} pageSize={this.pageSize}  category={"business"} country={"us"} />   } />
              <Route  path='/entertainment' element={ <News key={"entertainment"} pageSize={this.pageSize}  category={"entertainment"} country={"us"} />   } />
              <Route  path='/health' element={ <News key={"health"} pageSize={this.pageSize}  category={"health"} country={"us"} />   } />
              <Route  path='/science' element={ <News key={"science"} pageSize={this.pageSize}  category={"science"} country={"us"} />   } />
              <Route  path='/sports' element={ <News key={"sports"} pageSize={this.pageSize}  category={"sports"} country={"us"} />   } />
              <Route  path='/technology' element={ <News key={"technology"} pageSize={this.pageSize}  category={"technology"} country={"us"} />   } />
